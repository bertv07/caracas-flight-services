    ...
    <nav>
      <div className="nav-container">
        <div className="nav-links-">
          <Link to="/" className="nav-item ff-00" onClick={closeMenu}>
            Home
          </Link>
          <Link to="/contacto" className="nav-item ff-00" onClick={closeMenu}>
            Contáctanos
          </Link>
          <Link to="/ubicacion" className="nav-item ff-00" onClick={closeMenu}>
            Ubicación
          </Link>
          <Link to="/acerca-de" className="nav-item ff-00" onClick={closeMenu}>
            Acerca de
          </Link>
          <a href="#" onClick={handleProgramasClick} className="nav-item ff-00">
            Servicios
          </a>

          <div className="auth-buttons">
            {authenticated ? (
              <div className="auth-buttons-links">
